...
import { ExtensionLocation, ExternalDocumentationObject, ParameterObject, SecurityRequirementObject, SecuritySchemeObject, ServerVariableObject } from './interfaces/open-api-spec.interface.js';
export declare class DocumentBuilder {
    ...
    addServer(url: string, description?: string, variables?: Record<string, ServerVariableObject>, serverExtraProperties?: Record<string, any>): this;
    setExternalDoc(description: string, url: string): this;
    setBasePath(path: string): this;
    addTag(name: string, description?: string, externalDocs?: ExternalDocumentationObject, options?: {
        summary?: string;
        parent?: string;
        kind?: string;
    }): this;
