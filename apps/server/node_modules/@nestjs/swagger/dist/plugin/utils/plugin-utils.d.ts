...
export declare function getRecordValueType(type: ts.Type, typeChecker: ts.TypeChecker): ts.Type | undefined;
export declare function createAdditionalPropertiesValueSchema(valueType: ts.Type, typeChecker: ts.TypeChecker, factory: ts.NodeFactory): ts.Expression;
...
export declare function getStringLiteralUnionValues(type: ts.Type): {
...
export declare function normalizePackagePath(importPath: string): string;
