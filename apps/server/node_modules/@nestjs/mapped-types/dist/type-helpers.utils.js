...
export function applyValidateIfDefinedDecorator(targetClass, propertyKey) {
    if (!isClassValidatorAvailable()) {
        return;
    }
    const classValidator = require('class-validator');
...
export function inheritTransformationMetadata(parentClass, targetClass, isPropertyInherited, stackDecorators = true) {
...
export function inheritPropertyInitializers(target, sourceClass, isPropertyInherited = (key) => true) {
    try {
